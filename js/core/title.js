class TitleBig
{
    ...
    insert() {
        //#6f0d0d;
        //#3F1F1F;
        let text = `<section class="quickstart" style="padding-top: 20px; padding-bottom: 0px; margin : 0px; background-color: ` + this.backgroundColor + `;">
            <section class="intro">
              <div class="grid">
                <div class="unit whole center-on-mobiles">
                  <p class="first">` + this.titleText + `</p>
                </div>
              </div>
            </section>
        </section>`
